...
class Agreement(models.Model, AggregateBase):
  ...
  def _update_attrs(self, **kwargs):
    ...
    self.outcome_date = kwargs['outcome_date']
    ...
    self.outcome_notice_date = kwargs['outcome_notice_date']
    ...
    self.outcome_notice_alert_time_type = kwargs[
      'outcome_notice_alert_time_type']
    self.outcome_notice_alert_date = kwargs['outcome_notice_alert_date']
    ...
    self.expiration_alert_date = kwargs['expiration_alert_date']
