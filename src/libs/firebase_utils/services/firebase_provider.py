...
# apparently firebase requires an exp claim even though they say they dont': https://www.firebase.com/docs/rest/guide/user-auth.html#section-tokens-without-helpers
...
authentication = firebase.FirebaseAuthentication(FIREBASE_SECRET, 'abc', FIREBASE_DEBUG, True, {'exp': exp})
