...
@api_view(['PUT'])
def agreement_update_view(request, agreement_id, _potential_agreement_service=None, _agreement_service=None,
  ...
  if request.method == 'PUT':
    try:
      ...
      try:
        potential_agreement = potential_agreement_service.get_potential_agreement(agreement_id)
      ...
      except PotentialAgreement.DoesNotExist:
        pass

    except Exception as e:
      logger.debug("Error saving agreement: {0}".format(request.data), exc_info=True)
