...
from src.apps.api.resources.agreement.views.agreement import agreement_create_view, artifact_delete_view, \
  agreement_modify_view
...
urlpatterns = [
  ...
  url(r'^agreements/(?P<agreement_id>\w+)/(artifacts)/(?P<artifact_id>\w+)/$', artifact_delete_view),
