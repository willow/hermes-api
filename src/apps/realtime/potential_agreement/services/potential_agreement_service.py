...
def save_potential_agreement_in_firebase(potential_agreement_id, potential_agreement_name, potential_agreement_user_id,
  ...
  data = {'name': potential_agreement_name, 'viewers': {potential_agreement_user_id: True}}
